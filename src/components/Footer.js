                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/category/pharma-material" className="text-gray-400 hover:text-red-400 transition-colors">
                                    Pharma Material
                                </Link>
                            </li>
                            <li>
                                <Link to="/category/ibr-material" className="text-gray-400 hover:text-red-400 transition-colors">
                                    IBR Material
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li className="flex items-center space-x-2">
                                ...
                                <span className="text-gray-400">info@jaytraders.com</span>
                            </li>
